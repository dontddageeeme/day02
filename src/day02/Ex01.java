	...
	public static void main(String[] args) {
		/*
		 ...
		 자료형 : 데이터가 어떤 값인지에 따라 사용하는 값
		  ...
		  변수 생성
		  - 자료형 변수명; 또는 자료형 변수면 = 값;
		  - 1number(x), n22u11m33(o)
		  - changenumber => changeNumber 또는 change_number
		  - 예약어는 사용할 수 없다(이미 만들어져 있는것)
		...
		System.out.println(age+"살의 구나연 입니다");
		System.out.println(age+"살이지만 만으로는 "+(age-1)+"살 입니다");
